#pragma once
#include <cstdlib>
//#include vector and matrix classes here
...
{
protected:
    //mathlib::ParticleFactory pf;
    //mathlib::Particle* particleArray;
    //mathlib::GroundContacts groundContactGenerator;
...
protected:
    ...
    //mathlib::Contact contacts[maxContacts];

    /** Holds the collision data structure for collision detection. */
    //mathlib::CollisionData cData;

    /** Holds the contact resolver. */
    //mathlib::ContactResolver resolver;
